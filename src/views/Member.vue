      ...
      <Header/>
        <section class="section">
            <div v-if="member">
                    ...
                    <div class="card-content">
                        ...
                        <div class="media-content">
                           ...
                           <div class="media-right">
                              <button @click="deleteMember" class="button is-danger is-small">Supprimer le member</button>
                           </div>
                        </div>
                        <div class="content">
                ...
                <div class="box mt-5">{{messages.length}} dernier(s) messages postés </div>
                    <template v-for="message in messages">
                        <message :message="message" :key="message.id" :conversation="conversation"/>
                    </template>
            </div>
    </section>
  </div>
